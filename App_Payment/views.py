...
def payment(request):
    ...
    mypayment = SSLCSession(
        ...
        sslc_store_id="abcco656cf6297a654",
        sslc_store_pass="abcco656cf6297a654@ssl",
    )
...
def complete(request):
    ...
    if request.method == "post" or request.method == "POST":
        ...
        if status == "VALID":
            ...
            messages.success(
                request,
                f"Your Payment Completed Successfully! Page will be redirected!",
            )
            ...
            messages.warning(
                request,
                f"Your Payment Failed! Please Try Again! Page will be redirected!",
            )
